...
var Artist = function Artist(_ref) {
  ...
  return _react.default.createElement("div", null, _react.default.createElement("h3", null, "Name: ", name), _react.default.createElement("h4", null, "Followers: ", followers.total), _react.default.createElement("h4", null, "Genres: ", genres.join(',')), _react.default.createElement("h4", null, "Popularity: ", popularity), _react.default.createElement("img", {
...
function (_Component) {
  ...
  function Tracks() {
    ...
    _defineProperty(_assertThisInitialized(_this), "playAudioPreview", function (preview_url) {
      return function () {
        ...
        if (!_this.state.play) {
          ...
          if (_this.state.previewUrl === preview_url) {
            _this.setState({
              play: false
            });
          } else {
  ...
  _createClass(Tracks, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement("div", null, _react.default.createElement("ul", null, tracks.map(function (track) {
        var id = track.id,
            name = track.name,
            album = track.album,
        ...
        return _react.default.createElement("div", {
          key: id,
          onClick: _this2.playAudioPreview(preview_url)
...
function (_Component) {
  ...
  function Search() {
    ...
    _defineProperty(_assertThisInitialized(_this), "getArtistName", function (event) {
      _this.setState({
        musicArtist: event.target.value
      });
    });

    _defineProperty(_assertThisInitialized(_this), "handleArtistName", function (event) {
      if (event.key === 'Enter') {
        _this.searchArtist();
      }
    });
    ...
    _defineProperty(_assertThisInitialized(_this), "searchArtist", function () {
      {
        console.log('musicArtist:---', _this.state.musicArtist);
      }

      _this.props.searchArtistHistory(_this.state.musicArtist);
    });
...
function (_Component) {
  ...
  function App() {
    ...
    _defineProperty(_assertThisInitialized(_this), "searchArtistHistory", function (musicArtist) {
      console.log('artists name:', musicArtist);
      fetch("https://spotify-api-wrapper.appspot.com/artist/".concat(musicArtist)).then(function (response) {
        ...
        if (json.artists.total > 0) {
          ...
          fetch("https://spotify-api-wrapper.appspot.com/artist/".concat(_this.state.artist.id, "/top-tracks")).then(function (response) {
            return response.json();
          }).then(function (json) {
            _this.setState({
              tracks: json.tracks
  ...
  _createClass(App, [{
    ...
    value: function render() {
      return _react.default.createElement("div", null, _react.default.createElement("h2", null, "Music Master"), _react.default.createElement(_Search.default, {
        searchArtistHistory: this.searchArtistHistory
  ...
  return App;
}(_react.Component); // const AppWithHeader = ()=>{
// }
